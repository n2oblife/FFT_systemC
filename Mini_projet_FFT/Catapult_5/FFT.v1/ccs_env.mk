...
ifeq "$(PowerAnalysis_GENERATE_X_AWARE_ENABLE)" ""
PowerAnalysis_GENERATE_X_AWARE_ENABLE                  := yes
export PowerAnalysis_GENERATE_X_AWARE_ENABLE
endif
ifeq "$(PowerAnalysis_SYNCHRONOUS_RESET_AWARENESS)" ""
PowerAnalysis_SYNCHRONOUS_RESET_AWARENESS              := true
export PowerAnalysis_SYNCHRONOUS_RESET_AWARENESS
endif
ifeq "$(PowerAnalysis_ENABLE_POWER_ANALYSIS)" ""
PowerAnalysis_ENABLE_POWER_ANALYSIS                    := false
export PowerAnalysis_ENABLE_POWER_ANALYSIS
endif
...
ifeq "$(PowerAnalysis_ENABLE_FPGA_ANALYSIS)" ""
PowerAnalysis_ENABLE_FPGA_ANALYSIS                     := false
export PowerAnalysis_ENABLE_FPGA_ANALYSIS
endif
ifeq "$(PowerAnalysis_QWAVE_VIS_LIBDDI)" ""
PowerAnalysis_QWAVE_VIS_LIBDDI                         := 
export PowerAnalysis_QWAVE_VIS_LIBDDI
endif
ifeq "$(PowerAnalysis_USE_BIND_TO_TECH_CELL)" ""
PowerAnalysis_USE_BIND_TO_TECH_CELL                    := true
export PowerAnalysis_USE_BIND_TO_TECH_CELL
endif
