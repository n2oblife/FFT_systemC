...
# Generated date: Tue Mar 14 16:24:04 CET 2023
#
# ----------------------------------------------------------------------------
# ===================================================
...
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = ./prepwr_FFT.v/prepwr_FFT.v.vts
endif
endif
...
VHDL_SRC += 
VLOG_SRC += ./prepwr_FFT.v/prepwr_FFT.v.vts
endif
...
$(TARGET)/prepwr_FFT.v.vts: ./prepwr_FFT.v
...
$(TARGET)/prepwr_FFT.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/prepwr_FFT.v.vts: VLOG_F_OPTS=
$(TARGET)/prepwr_FFT.v.vts: NCVLOG_F_OPTS=
$(TARGET)/prepwr_FFT.v.vts: VCS_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/prepwr_FFT.v.vts: DUT_E=FFT

# Specify top design unit
$(TARGET)/prepwr_FFT.v.vts: VLOG_TOP=1
