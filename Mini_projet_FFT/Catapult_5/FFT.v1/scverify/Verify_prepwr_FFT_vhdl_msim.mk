...
# Generated date: Tue Mar 14 16:24:03 CET 2023
#
# ----------------------------------------------------------------------------
# ===================================================
...
ifeq ($(GATE_VHDL_DEP),)
GATE_VHDL_DEP = ./prepwr_FFT.vhdl/prepwr_FFT.vhdl.vhdlts
endif
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = 
endif
...
VHDL_SRC += ./prepwr_FFT.vhdl/prepwr_FFT.vhdl.vhdlts
VLOG_SRC += 
endif
...
$(TARGET)/prepwr_FFT.vhdl.vhdlts: ./prepwr_FFT.vhdl
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/prepwr_FFT.vhdl.vhdlts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/prepwr_FFT.vhdl.vhdlts: VHDL_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/prepwr_FFT.vhdl.vhdlts: DUT_E=FFT

# Specify top design unit
$(TARGET)/prepwr_FFT.vhdl.vhdlts: VHDL_TOP=1
